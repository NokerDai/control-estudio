...
# Ajustar path para importar la app principal
...
st.set_page_config(page_title="Hoy (Facundo)", page_icon="⏳", layout="centered")
st.title("⏳ Hoy — Facundo")
...
semana = -semana  # Facundo ve invertido
